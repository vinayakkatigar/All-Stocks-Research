...
public class FtseStockResearchUtility {

    public static final String FTSE_100_URL = "https://www.londonstockexchange.com/indices/ftse-100/constituents/table?lang=en&page=";
    public static final int FTSE_100_CNT = 7;

    public static final String FTSE_250_URL = "https://www.londonstockexchange.com/indices/ftse-250/constituents/table?lang=en&page=";
    public static final int FTSE_250_CNT = 14;

    private static Set<String> excludedIsinCodeSet = new HashSet<>();

    public static final String LSE_URL = "https://www.londonstockexchange.com/";
    ...
    private FtseStockResearchUtility(){
    }

    public static Map<String, List<FtseStockInfo>> getPopulatedFtse250StockMap() {
        return populatedFtse250StockMap;
    }

    public static void setPopulatedFtse250StockMap(Map<String, List<FtseStockInfo>> populatedFtse250StockMap) {
        FtseStockResearchUtility.populatedFtse250StockMap = populatedFtse250StockMap;
    }

    public static Map<String, List<FtseStockInfo>> getPopulatedFtse100StockMap() {
        return populatedFtse100StockMap;
    }

    public static void setPopulatedFtse100StockMap(Map<String, List<FtseStockInfo>> populatedFtse100StockMap) {
        FtseStockResearchUtility.populatedFtse100StockMap = populatedFtse100StockMap;
    }

    private static class FtseStockResearchUtilityHelper{
        private static final FtseStockResearchUtility INSTANCE = new FtseStockResearchUtility();
    }

    private  static Map<String, List<FtseStockInfo>>  populatedFtse250StockMap;
    private  static Map<String, List<FtseStockInfo>>  populatedFtse100StockMap;

    public static FtseStockResearchUtility getInstance(){
        return FtseStockResearchUtilityHelper.INSTANCE;
    }
    ...
    public synchronized static void createTableContents(StringBuilder dataBuffer, FtseStockInfo x) {
