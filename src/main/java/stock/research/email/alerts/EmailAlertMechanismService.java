...
import static stock.research.email.alerts.EmailAlertMechanismService.StockCategory.LARGE_CAP;
import static stock.research.email.alerts.EmailAlertMechanismService.StockCategory.MID_CAP;
import static stock.research.utility.StockResearchUtility.*;

@Service
public class EmailAlertMechanismService {
    enum StockCategory{LARGE_CAP, MID_CAP, SMALL_CAP};

    enum SIDE{BUY, SELL};
    private static final Logger LOGGER = LoggerFactory.getLogger(EmailAlertMechanismService.class);
...
//    @Scheduled(cron = "0 35 4,5,9,10 ? * MON-FRI")
    public void kickOffSwissEmailAlerts() {
        ...
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffSwissEmailAlerts" );
        ...
        LOGGER.info(Instant.now()+ " <-  Ended  EmailAlertMechanismService::kickOffSwissEmailAlerts" );

    }

    public void kickOffAustriaEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffAustriaEmailAlerts" );
    ...
    public void kickOffAustraliaEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffAustraliaEmailAlerts" );
    ...
    public void kickOffEUROEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffEUROEmailAlerts" );
    ...
    public void kickOffCanadaEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffCanadaEmailAlerts" );
    ...
    public void kickOffDenmarkEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffDenmarkEmailAlerts" );
    ...
    public void kickOffFinlandEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffFinlandEmailAlerts" );
    ...
    public void kickOffGermanyEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffGermanyEmailAlerts" );
    ...
    public void kickOffNetherlandsEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffNetherlandsEmailAlerts" );
    ...
    public void kickOffNorwayEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffNorwayEmailAlerts" );
        ...
        LOGGER.info(Instant.now()+ " <-  Ended  EmailAlertMechanismService::kickOffNorwayEmailAlerts" );
    }

    public void kickOffWorld1000EmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffWorld1000EmailAlerts" );
    ...
    public void kickOffSwedenEmailAlerts() {
        LOGGER.info(Instant.now()+ " <-  Started  EmailAlertMechanismService::kickOffSwedenEmailAlerts" );
...
//            helper.setTo(new String[]{"raghukati1950@gmail.com","raghu.kat@outlook.com"});
    ...
    public void setUpPortfolioData(){
        ...
        LOGGER.info("EmailAlertMechanismService::portfolioInfoList" + portfolioInfoList);
    }
