...
public class SensexController {
    ...
    public String sensexPnL(){
        ...
        writeHTMLFile((now().format(formatter))  + "SCREENER-SENSEX-ALERTS.html", data);
        return data;
    }
    ...
    public String sensexDaily(){
        ...
        writeHTMLFile((now().format(formatter))  + "SCREENER-SENSEX-DAILY.html", data);
        return data;
    }
    ...
    public String sensexYearLow(){
        ...
        writeHTMLFile((now().format(formatter))  + "SCREENER-SENSEX-YEAR-LOW.html", data);
        return data;
    }
