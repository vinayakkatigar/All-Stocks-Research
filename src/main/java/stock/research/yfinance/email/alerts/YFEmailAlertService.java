...
//    @Scheduled(cron = "0 30 1,8,14,23 ? * MON-SUN", zone = "GMT")
    @Scheduled(cron = "0 22 23 ? * MON-SUN", zone = "GMT")
...
*/
    ...
    @Scheduled(cron = "0 8 1,15,18,22 ? * MON-SUN", zone = "GMT")
...
//    @Scheduled(cron = "0 30 3,13,21 ? * MON-SUN", zone = "GMT")
...
*/
    ...
    @Scheduled(cron = "0 35 14 ? * MON-SUN", zone = "GMT")
...
//            helper.setTo(new String[]{"raghu_kat_stocks@outlook.com","raghu.kat@outlook.com"});
    ...
    public void createTableContents(StringBuilder dataBuffer, YFinanceStockInfo x) {
        ...
        dataBuffer.append("<td>" + x.getStockName() +
                ...
                + START_BRACKET + x.getStockCode() + " - " + x.getCcy() + " - " + x.getDividendRate() + END_BRACKET + "</td>");
