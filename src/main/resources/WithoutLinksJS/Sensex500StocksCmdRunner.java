...
public class Sensex500StocksCmdRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try (InputStream stream = new ClassPathResource("WithoutLinksJS/sensexhtmlhead.txt").getInputStream()){
            data = new String( stream.readAllBytes());
        }
        data = data + SensexStockResearchUtility.HTML_START;
        System.out.println("Sensex500StocksCmdRunner.run" + data);
